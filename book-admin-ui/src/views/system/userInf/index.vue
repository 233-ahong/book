<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="user_infList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="性别" align="center" prop="gender">
        <template slot-scope="scope">
          <dict-tag :options="sexDict" :value="scope.row.gender"/>
        </template>
      </el-table-column>
  ...
  methods: {
    ...
    getList () {
      ...
      listUserInf(this.queryParams).then(response => {
        this.user_infList = response.rows
